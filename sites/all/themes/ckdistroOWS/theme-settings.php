...
function ckdistroOWS_settings($saved_settings) {
	$settings = theme_get_settings('ckdistroOWS');
	$defaults = array(
	    'fast_tasks' => 1 ,
		'title_text' => 1 ,
		'title_text_custom' => "" /*,
	...
	$form['fast_tasks'] = array(
		...
		'#description' => t('Check the box above to enable ckdistroOWS&rsquo;s Fast Tasks'),
